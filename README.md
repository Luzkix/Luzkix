...
- **GreenBay application** - my own small REST API application
...
- **RPG game backend application** - main team project in project phase, RESTfull application
...
- **Mini Web Gallery** - last exercise in the list will redirect you to beautiful web gallery (html/css/javascript)
